    ...
    try {
      ...
      if (uid) {
        ...
        if (reviewData.status === "under_review") {
          ...
          tpl = NotificationTemplates.applicationRejected(selectedApp.applicationNumber || "", reviewData.comments)
          ...
          <div className="space-y-4">
            {filteredApplications.length === 0 ? (
              ...
              filteredApplications.map((app) => (
                <div key={app.id} className="border rounded-lg p-4 hover:bg-gray-50 transition-colors overflow-hidden">
                  <div className="flex flex-col md:flex-row md:items-start md:justify-between gap-3">
                    <div className="flex-1 min-w-0">
                      {/* Title + badges: wrap safely on mobile */}
                      <div className="flex flex-wrap items-center gap-2 mb-2">
                        <h3 className="font-medium text-gray-900 truncate max-w-full">
                          {app.title}
                        </h3>
                        <div className="flex items-center gap-2 shrink-0">
                          <Badge className={`whitespace-nowrap ${statusColors[app.status as keyof typeof statusColors]}`}>
                    ...
                    <div className="flex w-full md:w-auto flex-row gap-2 overflow-x-auto">
                      <Dialog>
                        ...
                        <DialogContent className="w-[95vw] max-w-3xl p-0">
                          ...
                          <div className="max-h-[70vh] overflow-y-auto px-4 py-4 sm:p-6 space-y-4">
